...
def problem2b(rect, n, delta, window):
    """
    ...
    p1=rg.Point(rect.corner_1.x,rect.corner_1.y)
    p2=rg.Point(rect.corner_2.x,rect.corner_2.y)
    for k in range(n):
        ...
        if rect.corner_1.y<rect.corner_2.y:
            ...
            p1.y=p1.y+delta
            p2.y=p2.y-delta
        rectn=rg.Rectangle(p1,p2)
        rectn.attach_to(window)
    window.render()
